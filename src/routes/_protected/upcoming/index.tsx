...
import { UpcomingEmptyState } from "@/components/empty-states";
...
function UpcomingPage() {
  ...
  return (
    <div className="flex-1 overflow-y-auto">
      {tasks.length === 0 ? (
        <UpcomingEmptyState onAddTask={handleAddTask} />
      ) : (
        <div className="container py-10 max-w-screen-2xl mx-auto px-4">
          <h1 className="text-3xl font-bold tracking-tight mb-6">Upcoming</h1>
